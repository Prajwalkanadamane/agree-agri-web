      ...
      <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl relative animate-fade-in-up">
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 mt-6">
            {userRole === 'buyer' ? (
              <button onClick={() => onContact(produce)} className="flex-1 bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded-lg transition-colors">Contact Farmer</button>
            ) : (
